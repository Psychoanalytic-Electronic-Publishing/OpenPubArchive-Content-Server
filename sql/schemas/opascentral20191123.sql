...
) ENGINE = InnoDB AUTO_INCREMENT = 119127 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'A list of all authorized users, and the NOT_LOGGED_IN user, with ID=0' ROW_FORMAT = Dynamic;
