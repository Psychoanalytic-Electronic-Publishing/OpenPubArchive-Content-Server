...
CREATE TABLE `api_productbase`  (
  ...
  `pep_class` set('book','journal','videostream','special','vidostream','bookseriessub','bookserieshead') CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT '',
...
CREATE TABLE `api_session_endpoints`  (
  ...
  `item_of_interest` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `api_sessions`  (
  ...
  `has_subscription` tinyint(1) NULL DEFAULT 0,
  `is_valid_login` tinyint(1) NULL DEFAULT 0,
  `is_valid_username` tinyint(1) NULL DEFAULT 0,
  `username` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'NotLoggedIn',
  `user_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'Individual',
