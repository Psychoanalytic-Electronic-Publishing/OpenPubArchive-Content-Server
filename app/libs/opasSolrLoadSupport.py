...
#class BiblioEntry(object):
    ...
    #"""
    #def __init__(self, art_id, ref, db_bib_entry=[]):
        #import models
        #if not db_bib_entry:
            #self.last_update = datetime.today()
            #self.rx = opasxmllib.xml_get_element_attr(ref, "rx", default_return=None)
            #self.rx_confidence = float(opasxmllib.xml_get_element_attr(ref, "rxconf", default_return=None))
            #self.rxcf = opasxmllib.xml_get_element_attr(ref, "rxcf", default_return=None) # related rx
            #self.rxcf_confidence = float(opasxmllib.xml_get_element_attr(ref, "rxcfconf", default_return=0)) # related rx
        #else:
        ...
        #book_title = opasxmllib.xml_get_subelement_textsingleton(ref, "bst")
            ...
            #self.year_of_publication = opasxmllib.xml_get_subelement_textsingleton(ref, "bpd")
                ...
                #year = opasxmllib.xml_get_subelement_textsingleton(ref, "y")
