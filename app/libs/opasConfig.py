...
DESCRIPTION_WORD = "A word prefix to return a limited word index."
DESCRIPTION_WORDFIELD = "The field for which to look up the prefix for matching index entries"
...
ENDPOINT_SUMMARY_WORD_WHEEL = "Bring back the alphabetic start of the matching terms for the prefix in the specified field"
