...
COPYRIGHT_PAGE_HTML = """
                    <div class="copyrightpage">
                        ...
                        provisions.</p>
                        <p style="padding-left: 22px; text-indent: -28px;">1. All copyright
                        ...
                        <p style="padding-left: 22px; text-indent: -28px;">2. Authorized
                        ...
                        <p style="padding-left: 22px; text-indent: -28px;">3. During the
