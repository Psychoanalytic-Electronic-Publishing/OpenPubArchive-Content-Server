...
class GlossaryRecognitionEngine(UserDict):
    ...
    def __loadGlossaryTerms(self):
        ...
        if self.gather:
            print (80*"*")
            print ("Loading regex patterns.  Gathering regex patterns is ON.")
            print (80*"*")
        else:
            print (80*"*")
            print ("Loading regex patterns.  Gathering regex patterns is OFF.")
            print (80*"*")
        ...
        # load main data
        print ("%d input patterns loaded into %d regex patterns." % (len(match_list), len(retVal)))
        return retVal
