...
DESCRIPTION_LOGGEDINRECORDS = "Include logged-in in records (True) or non-logged-in (False)"
...
TITLE_LOGGEDINRECORDS = "Include logged-in in records (True) or non-logged-in (False)"
